...
pub struct AwardNomineeBaseRecord {
    ...
    pub character: Option<Box<models::Character>>,
    #[serde(rename = "details", skip_serializing_if = "Option::is_none")]
    pub details: Option<String>,
    #[serde(rename = "episode", skip_serializing_if = "Option::is_none")]
    pub episode: Option<Box<models::EpisodeBaseRecord>>,
    ...
    pub movie: Option<Box<models::MovieBaseRecord>>,
    #[serde(rename = "series", skip_serializing_if = "Option::is_none")]
    pub series: Option<Box<models::SeriesBaseRecord>>,
