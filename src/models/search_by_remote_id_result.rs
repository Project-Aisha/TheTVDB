...
pub struct SearchByRemoteIdResult {
    ...
    pub series: Option<models::SeriesBaseRecord>,
    #[serde(rename = "people", skip_serializing_if = "Option::is_none")]
    pub people: Option<models::PeopleBaseRecord>,
    #[serde(rename = "movie", skip_serializing_if = "Option::is_none")]
    pub movie: Option<models::MovieBaseRecord>,
    #[serde(rename = "episode", skip_serializing_if = "Option::is_none")]
    pub episode: Option<models::EpisodeBaseRecord>,
    #[serde(rename = "company", skip_serializing_if = "Option::is_none")]
    pub company: Option<models::Company>,
}
