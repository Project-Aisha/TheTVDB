...
pub struct MovieExtendedRecord {
    ...
    pub artworks: Option<Vec<models::ArtworkBaseRecord>>,
    ...
    pub awards: Option<Vec<models::AwardBaseRecord>>,
    ...
    pub characters: Option<Vec<models::Character>>,
    ...
    pub production_countries: Option<Vec<models::ProductionCountry>>,
    #[serde(rename = "releases", skip_serializing_if = "Option::is_none")]
    pub releases: Option<Vec<models::Release>>,
    #[serde(rename = "remoteIds", skip_serializing_if = "Option::is_none")]
    pub remote_ids: Option<Vec<models::RemoteId>>,
    #[serde(
        rename = "runtime",
        default,
    ...
    pub studios: Option<Vec<models::StudioBaseRecord>>,
    ...
    pub tag_options: Option<Vec<models::TagOption>>,
    #[serde(rename = "trailers", skip_serializing_if = "Option::is_none")]
    pub trailers: Option<Vec<models::Trailer>>,
    #[serde(rename = "translations", skip_serializing_if = "Option::is_none")]
    pub translations: Option<Box<models::TranslationExtended>>,
