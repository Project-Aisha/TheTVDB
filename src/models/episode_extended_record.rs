...
pub struct EpisodeExtendedRecord {
    ...
    pub image_type: Option<Option<i32>>,
    ...
    pub networks: Option<Vec<models::Company>>,
    #[serde(rename = "nominations", skip_serializing_if = "Option::is_none")]
    pub nominations: Option<Vec<models::AwardNomineeBaseRecord>>,
    ...
    pub studios: Option<Vec<models::Company>>,
