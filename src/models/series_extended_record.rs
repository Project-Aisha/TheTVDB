...
pub struct SeriesExtendedRecord {
    ...
    pub airs_days: Option<Box<models::SeriesAirsDays>>,
    ...
    pub artworks: Option<Vec<models::ArtworkExtendedRecord>>,
    #[serde(
    ...
    pub companies: Option<Vec<models::Company>>,
    ...
    pub original_network: Option<Box<models::Company>>,
    ...
    pub latest_network: Option<Box<models::Company>>,
    #[serde(
