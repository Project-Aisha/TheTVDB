...
pub async fn get_all_series(
    ...
    page: Option<f64>,
) -> Result<models::GetAllSeries200Response, Error<GetAllSeriesError>> {
...
pub async fn get_series_artworks(
    ...
    lang: Option<&str>,
    r#type: Option<i32>,
) -> Result<models::GetSeriesArtworks200Response, Error<GetSeriesArtworksError>> {
    let local_var_configuration = configuration;
...
pub async fn get_series_base(
    configuration: &configuration::Configuration,
    id: f64,
) -> Result<models::GetSeriesBase200Response, Error<GetSeriesBaseError>> {
    let local_var_configuration = configuration;
...
pub async fn get_series_base_by_slug(
    configuration: &configuration::Configuration,
    slug: &str,
) -> Result<models::GetSeriesBase200Response, Error<GetSeriesBaseBySlugError>> {
    let local_var_configuration = configuration;
...
pub async fn get_series_episodes(
    ...
    air_date: Option<&str>,
) -> Result<models::GetSeriesEpisodes200Response, Error<GetSeriesEpisodesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_series_extended(
    ...
    meta: Option<&str>,
    short: Option<bool>,
) -> Result<models::GetSeriesArtworks200Response, Error<GetSeriesExtendedError>> {
    let local_var_configuration = configuration;
...
pub async fn get_series_filter(
    ...
    status: Option<f64>,
    year: Option<f64>,
) -> Result<models::GetSeriesFilter200Response, Error<GetSeriesFilterError>> {
    let local_var_configuration = configuration;
...
pub async fn get_series_next_aired(
    configuration: &configuration::Configuration,
    id: f64,
) -> Result<models::GetSeriesBase200Response, Error<GetSeriesNextAiredError>> {
    let local_var_configuration = configuration;
...
pub async fn get_series_season_episodes_translated(
    ...
    models::GetSeriesSeasonEpisodesTranslated200Response,
...
pub async fn get_series_translation(
    ...
    id: f64,
    language: &str,
) -> Result<models::GetEpisodeTranslation200Response, Error<GetSeriesTranslationError>> {
    let local_var_configuration = configuration;
