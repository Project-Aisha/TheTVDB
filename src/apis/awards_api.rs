...
) -> Result<models::GetAllAwards200Response, Error<GetAllAwardsError>> {
...
pub async fn get_award(
    configuration: &configuration::Configuration,
    id: f64,
) -> Result<models::GetAward200Response, Error<GetAwardError>> {
    let local_var_configuration = configuration;
...
pub async fn get_award_extended(
    configuration: &configuration::Configuration,
    id: f64,
) -> Result<models::GetAwardExtended200Response, Error<GetAwardExtendedError>> {
    let local_var_configuration = configuration;
