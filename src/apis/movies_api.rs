...
pub async fn get_all_movie(
    ...
    page: Option<f64>,
) -> Result<models::GetAllMovie200Response, Error<GetAllMovieError>> {
...
pub async fn get_movie_base(
    configuration: &configuration::Configuration,
    id: f64,
) -> Result<models::GetMovieBase200Response, Error<GetMovieBaseError>> {
    let local_var_configuration = configuration;
...
pub async fn get_movie_base_by_slug(
    configuration: &configuration::Configuration,
    slug: &str,
) -> Result<models::GetMovieBase200Response, Error<GetMovieBaseBySlugError>> {
    let local_var_configuration = configuration;
...
pub async fn get_movie_extended(
    ...
    meta: Option<&str>,
    short: Option<bool>,
) -> Result<models::GetMovieExtended200Response, Error<GetMovieExtendedError>> {
    let local_var_configuration = configuration;
...
pub async fn get_movie_translation(
    ...
    id: f64,
    language: &str,
) -> Result<models::GetEpisodeTranslation200Response, Error<GetMovieTranslationError>> {
    let local_var_configuration = configuration;
...
pub async fn get_movies_filter(
    ...
    status: Option<f64>,
    year: Option<f64>,
) -> Result<models::GetMoviesFilter200Response, Error<GetMoviesFilterError>> {
    let local_var_configuration = configuration;
