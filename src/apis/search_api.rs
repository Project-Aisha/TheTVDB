...
pub async fn get_search_results(
    ...
    offset: Option<f64>,
    limit: Option<f64>,
) -> Result<models::GetSearchResults200Response, Error<GetSearchResultsError>> {
...
pub async fn get_search_results_by_remote_id(
    configuration: &configuration::Configuration,
    remote_id: &str,
) -> Result<models::GetSearchResultsByRemoteId200Response, Error<GetSearchResultsByRemoteIdError>> {
    let local_var_configuration = configuration;
